...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        when(lemonadeState){
            ...
            // When the image is clicked in the DRINK state the state should become RESTAR
